    ...
    n.extend({
        ...
        ajax: function (b, c) {
            ...
            (k = n.event && m.global),
                ...
                x.setRequestHeader(
                    "Accept",
                    m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + tb + "; q=0.01" : "") : m.accepts["*"]
                );
    ...
    n.ajaxSetup({
        ...
        n.ajaxPrefilter("json jsonp", function (b, c, d) {
            var e,
                ...
                h =
                    b.jsonp !== !1 &&
                    (Jb.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-form-urlencoded") && Jb.test(b.data) && "data");
