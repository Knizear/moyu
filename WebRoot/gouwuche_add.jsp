                ...
                <form action="gouwuche.jsp?a=insert" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10"><%
                            Map mapchanpinfenlei3 = new CommDAO()
                                .find("SELECT fenleimingcheng FROM chanpinfenlei where id='" + readMap.get("chanpinfenlei") + "'");
                            %>
<%= mapchanpinfenlei3.get("fenleimingcheng") %><input type="hidden" id="chanpinfenlei" name="chanpinfenlei" value="<%= Info.html(readMap.get("chanpinfenlei")) %>" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
