...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 活动 </span>
            <span>列表</span>
        </div>
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="huodongmingcheng" value="<%= request.getParameter("huodongmingcheng") !=null ? request.getParameter("huodongmingcheng") : "" %>" />
                    </div>
                    <div class="form-group">添加时间</div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                <a href="huodong_detail.jsp?id=<%= map.get("id") %>">详情</a>
                                <a href="huodong_updt.jsp?id=<%= map.get("id") %>">编辑</a>
                                <a href="huodong.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
