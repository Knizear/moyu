    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="chanpinxinxi.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_chanpinfenlei11"
                                    data-value=""
                                    data-rule-required="true"
 ...
 <% for (Map m : select) { %>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" data-rule-required="true" data-msg-required="请填写产品图片" id="chanpintupian" name="chanpintupian" value="" />
                                <script>
