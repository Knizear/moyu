...
<html>
    ...
    <body leftMargin="5" topMargin="5" rightMargin="5">
        ...
        <table width="100%" height="193" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF" style="border-collapse: collapse">
            <tbody>
                <tr align="middle" bgcolor="#ffffff">
                    <td colspan="2" bgcolor="#CADCEA"><strong>农业园导览及农产品销售系统</strong></td>
                </tr>
                <tr align="middle" bgcolor="#ffffff">
                    <td width="10%" align="left">项目名称：</td>
                    <td width="41%" align="left"><font class="t4">农业园导览及农产品销售系统</font></td>
                </tr>
                <tr align="middle" bgcolor="#ffffff">
                    <td align="left">制作团队：</td>
                    <td align="left">摸鱼队</td>
                </tr>
                <tr align="middle" bgcolor="#ffffff">
                    <td align="left">成员：</td>
                    <td align="left"><font class="t41">林沛甫，何俊君，江晓彤，封腾飞，周宇阳</font></td>
                </tr>
            </tbody>
        </table>
        <p>&nbsp;</p>
