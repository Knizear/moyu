...
if (a.equals("insert")) {
    ...
    new CommDAO().commOper("UPDATE gouwuche SET xiaoji=(goumaishuliang*chanpinjiage) WHERE id='" + charuid + "'");
    ...
    new CommDAO()
        .commOper("UPDATE gouwuche SET xiaoji=(goumaishuliang*chanpinjiage) WHERE id='" + request.getParameter("id") + "'");
