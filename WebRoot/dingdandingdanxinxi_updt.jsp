...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmap(request.getParameter("id"), "dingdandingdanxinxi");
     %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑订单订单信息:</div>
            <div class="panel-body">
                <form action="dingdandingdanxinxi.jsp?a=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_chanpinfenlei21" data-value="<%= Info.html(mmm.get("chanpinfenlei")) %>" id="chanpinfenlei" name="chanpinfenlei" style="width: 250px">
 ...
 <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_chanpinfenlei21").val($(".class_chanpinfenlei21").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" id="chanpintupian" name="chanpintupian" value="<%= Info.html(mmm.get("chanpintupian")) %>" />
                                <script>
